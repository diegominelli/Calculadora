...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   * Adiciona o número selecionado para o cáculoposteriormente.
   * 
   * @param string  numero
   * @return void
   */
  ...
  definirOperacao(operacao: string): void {
    // apenas define uma operacao caso nao exista uma
    if (this.operacao === null) {
